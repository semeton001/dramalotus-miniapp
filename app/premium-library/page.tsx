...
export default async function PremiumLibraryPage() {
  ...
  return (
    <main style={{ padding: 24, maxWidth: 800 }}>
      <h1 style={{ marginBottom: 12 }}>Premium Library</h1>
      <p style={{ marginBottom: 20, opacity: 0.8 }}>
        Halaman ini hanya bisa dibuka oleh user VIP.
      </p>
      ...
      >
        ...
        <ul style={{ margin: 0, paddingLeft: 20, lineHeight: 1.8 }}>
          <li>Contoh fitur paywalled berbasis membership_status.</li>
          <li>Reusable pattern untuk premium library, episode eksklusif, bonus scene, dll.</li>
          <li>Semua akses diproteksi oleh requireVip().</li>
        </ul>
      </section>
    </main>
  );
