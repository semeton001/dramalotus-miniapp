...
export default function HomeScreen({
  ...
  return (
    <main className="min-h-[100dvh] bg-[#050507] text-[#F5F1E8]">
      <div className="mx-auto flex min-h-[100dvh] w-full max-w-[430px] flex-col px-4 pb-28 pt-6">
        <header className="relative overflow-hidden rounded-[30px] border border-white/10 bg-[#12131A] px-5 py-6 shadow-[0_18px_40px_rgba(0,0,0,0.28)]">
          ...
          <div className="relative text-center">
            ...
            <div className="mx-auto mt-4 flex h-24 w-24 items-center justify-center overflow-hidden rounded-[28px] border border-[#C9A45C]/15 bg-[linear-gradient(135deg,rgba(201,164,92,0.08),rgba(185,138,132,0.04))] shadow-[0_0_60px_rgba(201,164,92,0.08)]">
              <Image
            ...
            <h1 className="font-ExoBold mt-4 text-[34px] tracking-[0.02em] text-[#D9B36A]">
              DRAMALOTUS
            </h1>

            <p className="mx-auto mt-2 max-w-xs text-center text-[14px] leading-6 text-[#CFC5B5]">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button
                type="button"
                className="rounded-[22px] border border-white/10 bg-white/[0.03] px-4 py-4 text-sm font-medium text-[#DDD4C4] transition hover:bg-white/[0.05]"
              >
                Bagikan
              </button>
              <button
              ...
              >
                <div className="flex min-h-[126px] flex-col items-center justify-start">
                  <div className="relative flex items-start justify-center">
                    ...
                    {source.badge && (
                      <span className="absolute -right-4 -top-1 z-10 rounded-full bg-[linear-gradient(135deg,#B76E79,#C98B57)] px-2.5 py-1 text-[10px] font-semibold text-white shadow-[0_6px_16px_rgba(201,164,92,0.18)]">
                        {source.badge}
                      </span>
                    )}
                  </div>
